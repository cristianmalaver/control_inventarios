...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <br>
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Vender Productos</h1>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              ...
              <div class="text-center">
                <h4 class="m-0 font-weight-bold text-primary">Productos Vendidos</h4>
              </div>
            </div>
  ...
  <!-- Modal -->
  <div class="modal fade fullscreen-modal text-center" id="customerModal" tabindex="-1" role="dialog" aria-labelledby="customerModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
              ...
              <div class="form-row mb-1">
                ...
                <div class="col-md-4 mb-1">
                  ...
                  <div class="bmd-label-floating">
                    <h6 class="bmd-label-floating">Nombre del producto</h6>
